...
# =============================================================================
# Set random seeds for exact reproducibility of evolutionary runs
SEED = 42
random.seed(SEED)
np.random.seed(SEED)
...
# Primitive Set explicitly tailored for Direct Reciprocity
...
# =============================================================================
# 3. AGENT-BASED MODEL (Asymmetric Topology & Strict Forgiveness)
# =============================================================================
...
def run_evolution():
    ...
    print("Initializing Direct Reciprocity Baseline Module...")
...
def plot_dashboard(best_ind, history, model_config, evo_config, control_fit):
    ...
    ax_plot.set_title('Direct Reciprocity: Evolutionary Performance Dynamics')
