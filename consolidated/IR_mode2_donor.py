...
# Primitive Set explicitly tailored for Assessment Rules (Justice System)
...
class CooperationModel(mesa.Model):
    ...
    def resolve(self, donor, recipient, cooperates):
        ...
        if self.control_mode:
            ...
            # EVOLVED iGSS ASSESSMENT: Using the GP Rule
...
def run_evolution():
    ...
    print("Initializing Indirect Reciprocity [MODE 2 - Assessment Search]...")
...
def plot_deap_tree(individual):
    ...
    ax_tree.set_title("GP Assessment Rule (Justice System)", fontsize=14)
    ax_tree.axis("off")
...
def plot_dashboard(best_ind, history, model_config, evo_config, control_fit):
    ...
    report_text = (
        f"\n{'='*50}\n"
        f"      INDIRECT RECIPROCITY [MODE 2] REPORT\n"
        f"{'='*50}\n"
    ...
    ax_plot.set_title('Indirect Reciprocity [Mode 2]: Search for Assessment Norms')
