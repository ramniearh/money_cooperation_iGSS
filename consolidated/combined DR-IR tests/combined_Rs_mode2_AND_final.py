...
# =============================================================================
# 2. GENETIC PROGRAMMING SETUP (UNIVERSAL JUSTICE SYSTEM)
# =============================================================================
def random_constant():
    return random.choice([-10, -1, 0, 1, 10])

# Primitive Set takes 3 variables: Action, Public Standing of Victim, Private Grudge
...
# =============================================================================
# 3. AGENT-BASED MODEL (Dual-Ledger Resolution)
# =============================================================================
class CoopAgent(mesa.Agent):
    ...
    def evaluate_partner(self, partner):
        ...
        # iGSS FIXED ACTION: The Paranoid Hybrid
...
class CooperationModel(mesa.Model):
    ...
    def resolve(self, donor, recipient, cooperates):
        ...
        if self.control_type == "Control-TFT":
            ...
            # EVOLVED iGSS ASSESSMENT: Universal Justice System
            action_val = 1 if cooperates else 0
            in_memory_val = 1 if donor.unique_id in recipient.memory else 0
            
            decision_score = self.igss_rule(action_val, recipient.standing, in_memory_val)
            
            if decision_score > 0:
                # Judged GOOD: Restore Standing, Clear Grudge
                donor.standing = 1
                recipient.memory.discard(donor.unique_id)
            else:
                # Judged BAD: Destroy Standing, Hold Grudge
                donor.standing = 0
                recipient.memory.add(donor.unique_id)
...
def run_evolution():
    ...
    print("Initializing Combined [MODE 2] (Universal Justice System)...")
...
def plot_deap_tree(individual):
    ...
    ax_tree.set_title("GP Assessment Rule (Universal Justice)", fontsize=14)
    ax_tree.axis("off")
...
def plot_dashboard(best_ind, history, model_config, evo_config, dr_fit, ir_fit):
    ...
    report_text = (
        f"\n{'='*60}\n"
        f"      COMBINED [MODE 2] REPORT (Universal Justice)\n"
        f"{'='*60}\n"
    ...
    ax_plot.set_title('Institutional Competition: Evolving the Justice System')
