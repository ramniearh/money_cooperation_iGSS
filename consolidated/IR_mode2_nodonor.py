...
def run_evolution():
    ...
    print("Initializing Indirect Reciprocity [MODE 2 - Strict 2-Variable Search]...")
...
def plot_deap_tree(individual):
    ...
    ax_tree.set_title("GP Assessment Rule (Strict 2-Variable)", fontsize=14)
    ax_tree.axis("off")
...
def plot_dashboard(best_ind, history, model_config, evo_config, control_fit):
    ...
    report_text = (
        f"\n{'='*50}\n"
        f"      INDIRECT RECIPROCITY [MODE 2 - STRICT] REPORT\n"
        f"{'='*50}\n"
    ...
    ax_plot.set_title('Indirect Reciprocity [Mode 2 - Strict]: Assessment Norms')
