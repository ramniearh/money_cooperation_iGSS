# =============================================================================
# FILE: evolution_full.py
# PURPOSE: Evolving an institution under pressure of Scarcity, Freeloaders, and Tax.
# =============================================================================
...
from model_full import FullModel # Importing the new model
...
def evaluate_rule(individual):
    ...
    total_fitness = 0
    for _ in range(5): 
        # 30 Total Agents: 25 Good Guys, 5 Freeloaders
        m = FullModel(30, 5, rule=rule_func)
        
        # 20 Days. They start with 10 vitality. 
        # If they don't eat foreign goods, they die on Day 10.
        for _ in range(20): 
            m.step()
...
if __name__ == "__main__":
    ...
    print("Starting the Ultimate Crucible (Scarcity + Freeloaders + Tax)...")
    ...
    for gen in range(1, 21): 
        # ELITISM: Save the absolute best equation so it never degrades
        ...
        pop[:] = offspring
        pop.append(elite_clone) # Put the Elite back in the pool
