...
from model_topology import TopologyModel 
...
def evaluate_rule_in_mesa(individual):
    ...
    total_fitness = 0
    for _ in range(5): 
        # 30 agents, 10x10 Grid
        m = TopologyModel(30, 10, 10, rule=rule_func)
        # 20 ticks of random wandering
        for _ in range(20):
            m.step()
...
if __name__ == "__main__":
    ...
    print("Starting Evolution with Spatial Topology...")
